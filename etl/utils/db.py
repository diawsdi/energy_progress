...
# Database models
from sqlalchemy import Column, Integer, String, Float, Date, DateTime, Text, ForeignKey, Index, text
...
class AreaTimeseries(Base):
    ...
    # Indexes
    __table_args__ = (
        Index("ix_area_timeseries_month", month),
    )
...
class ProcessingJob(Base):
    ...
    # Indexes
    __table_args__ = (
        Index("ix_processing_jobs_area_id", area_id),
